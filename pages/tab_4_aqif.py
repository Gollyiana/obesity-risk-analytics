...
# ==========================================
st.title("⚖️ Predictive Risk Assessment Dashboard")
...
# Form Layout split neatly into 2 columns
...
if st.button("🚀 Calculate Risk Profile", use_container_width=True):
    with st.spinner("Processing features through ML Pipeline..."):
        ...
        # Check if Member 3's backend model is loaded successfully
        if model is not None:
            ...
            # Intuitive mathematical fallback logic if model file is missing
            risk_score = int(np.clip(50 + (bmi * 0.5) - (ch2o * 10), 0, 100))
        ...
        st.write("This interactive simulation displays how modifying your water intake would adjust your overall risk score, keeping other clinical inputs fixed.")
